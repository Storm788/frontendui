...
import { StudentButton } from "../Components/StudentCUDButton"
 ...
 */
const StudentListPageContent = ({student}) => {
    return (<>
...
const StudentPageContentLazy = ({student}) => {
    ...
    return (<>
        ...
        {entity && <StudentListPageContent student={entity}  onChange={handleChange} onBlur={handleBlur} />}
    </>)
}
